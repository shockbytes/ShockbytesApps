...
import static at.shockbytes.apps.util.AppParams.REQUEST_PERMISSION_ALL_PERMISSIONS;
...
public class ShockFingerprintManager {
    ...
    public ShockFingerprintManager(Context context, FingerprintManager fingerprintManager) {
